...
from scalable_proportional_pb import parse_pabulib_file, ees_with_outcome, add_opt_cardinal
from scalable_proportional_pb.ees import cardinal_utility
from core.cli import setup_results_dir, save_results


def exact_method_of_equal_shares_with_completion_approval_exhaustive(pabulib_file: str):
    """
